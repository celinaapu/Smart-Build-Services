...
const mockArtisans: Artisan[] = [
  ...
  },
  {
    ...
    location: "Surulere, Lagos",
    image:
      "https://res.cloudinary.com/celina/image/upload/v1757773784/Pasted_image_ujo01h.png",
    rating: 4.9,
    verified: true,
  },
  {
    ...
    <div className="mb-8">
      <div className="flex overflow-x-auto gap-6 pb-4">
        {mockArtisans.map((artisan) => (
          <div
            key={artisan.id}
            className="flex-shrink-0 shadow-2xl w-[381px] h-[296px] bg-white rounded-[35px] border border-gray-200 overflow-hidden"
          >
